...
@endphp
    <div class="col d-flex topbar-controls align-items-center">
        <div class="d-none d-md-block left-bar-ctrl">
            <i class="ms-2 fas fa-outdent fa-lg" dir="collapse"></i>
        </div>
        ...
        <div class="ms-2 custom-scroll nav-controls">
            <div class="d-inline-block menu-direction-control scroll-x align-self-center mx-1" data-direction="left"><i class="fas fa-lg fa-chevron-left"></i></div>
            <div class="d-inline-block nav-container scroll-container px-0">
                <ul class="px-0 mx-0 nav-icons mb-1">
                    {{-- Example menu <li><i class="fab fa-internet-explorer"></i></li> --}}
                    @yield('topbar_menus')
                </ul>
            </div>
            <div class="d-inline-block menu-direction-control scroll-x align-self-center mx-1" data-direction="right"><i class="fas fa-lg fa-chevron-right"></i></div>
        </div>
    </div>
